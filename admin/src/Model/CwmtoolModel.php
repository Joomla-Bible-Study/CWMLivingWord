 ...
 * @since  5.4.0
 */
class CwmtoolModel extends AdminModel
{
    /**
    ...
    {
        $form = $this->loadForm('com_livingword.tool', 'tool', ['control' => 'jform', 'load_data' => $loadData]);
     ...
     * @since   5.4.0
     */
    public function getTable($name = 'Cwmtool', $prefix = '', $options = []): Table
    {
    ...
    {
        $data = Factory::getApplication()->getUserState('com_livingword.edit.cwmtool.data', []);
